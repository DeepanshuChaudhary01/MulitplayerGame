...
//     {
//         currentPlayer = Instantiate(playerModels[characterController.GetSelectedIndex()], playerModels[characterController.GetSelectedIndex()].transform.parent).GetComponent<PlayerController>();
